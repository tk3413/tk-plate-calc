...
// PlateCount defines model for PlateCount.
type PlateCount struct {
	// N10 Count of 10 lb plates
	N10 *int `json:"10,omitempty"`

	// N25 Count of 25 lb plates
	N25 *int `json:"25,omitempty"`

	// N2pt5 Count of 2.5 lb plates
	N2pt5 *int `json:"2pt5,omitempty"`

	// N45 Count of 45 lb plates
	N45 *int `json:"45,omitempty"`

	// N5 Count of 5 lb plates
...
type ServerInterface interface {
	// Calculate plate counts
	// (GET /weights)
	GetWeights(w http.ResponseWriter, r *http.Request, params GetWeightsParams)
}
...
// GetWeights operation middleware
func (siw *ServerInterfaceWrapper) GetWeights(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetWeightsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetWeights(w, r, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/weights", wrapper.GetWeights)
